...
interface BoundaryConditionsTableProps {
  ...
  onEdit: (bc: BoundaryCondition) => void
}

export function BoundaryConditionsTable({ conditions, onChange, onEdit }: BoundaryConditionsTableProps) {
                ...
                <tr key={bc.id} className="border-b hover:bg-muted/50">
                  ...
                  <td className="p-3">
                    <div className="flex gap-2">
                      <Button variant="ghost" size="icon" onClick={() => onEdit(bc)}>
